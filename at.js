...
exports.run = (client, message, args) => {
  ...
  if (reason.length < 1) return message.reply('Sunucudan atma sebebini belirtmedin.');
  if (message.mentions.users.size < 1) return message.reply('Kimi sunucudan atacağını belirtmedin.').catch(console.error);
