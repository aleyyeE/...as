...
module.exports.run = async(client, message, args) => {
  const duration = moment.duration(client.uptime).format(" D [gün], H [saat], m [dakika], s [saniye]");
    ...
    .addField(`Discord.js sürümü:`, Discord.version)
      .addField(':spy: Yapımcım:', '<@242290918269517824> \n `aLi`')
      .addField(':paperclip: Botun Başlanma Zamanı:', "Bot **12.01.2019**'de yapılmaya başlanmıştır")
    .setFooter('aLi', client.user.avatarURL)
    .setTimestamp()
